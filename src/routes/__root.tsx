...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Mak Electronics — Mobile Repair Shop, Faridpur" },
      { name: "description", content: "Expert mobile repair in Faridpur: screen, battery, water damage, software unlock. Same-day service with 1-year warranty." },
      { property: "og:title", content: "Mak Electronics — Expert Mobile Repair" },
      { property: "og:description", content: "Fast, trusted mobile phone repair. Genuine parts, 1-year warranty." },
